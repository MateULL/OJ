...
if os.getenv("OJ_USE_SQLITE", "0") == "1":
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("MYSQL_DATABASE", "oj"),
...
TESTCASE_ROOT = Path(os.getenv("TESTCASE_ROOT", BASE_DIR / "testdata")).resolve()
JUDGE_WORK_ROOT = Path(os.getenv("JUDGE_WORK_ROOT", BASE_DIR / "judge_work")).resolve()
